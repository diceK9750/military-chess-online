...
仕様 v0.1 の文書化段階です。正規座標、各23配置地点、HQ、READY、自動PASS、終局判定、終局後公開、通信の一貫性方針を承認仕様として反映しています。R1（仮想アンカーによるHQ周辺の移動幾何）と飛行機のHQ間直接移動も正式仕様として反映し、アンカー数・使用列の未解決事項は解消済みです。
...
- [プレイヤー操作の流れ](docs/USER_FLOW.md)：スマートフォンでの開始・対局・再開と未承認の操作案。
